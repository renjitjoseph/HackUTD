  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        {currentInsight && (
          <View style={styles.insightCard}>
            <View style={styles.insightHeader}>
              <Ionicons name="bulb" size={24} color="#E20074" />
      ...
      <View style={styles.bottomNav}>
        ...
        >
          <MaterialCommunityIcons name="ticket-percent" size={24} color="#E20074" />
          <Text style={[styles.navLabel, { color: '#E20074' }]}>Status</Text>
        </TouchableOpacity>
